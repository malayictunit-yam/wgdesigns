...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "William Gutang Design Studio — Jersey & Apparel Design" },
      { property: "og:description", content: "Custom sports jerseys, esports apparel, team uniforms, streetwear graphics and event merchandise by William Gutang." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "William Gutang Design Studio — Jersey & Apparel Design" },
      { name: "twitter:description", content: "Custom sports jerseys, esports apparel, team uniforms, streetwear graphics and event merchandise by William Gutang." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/gTvumTS5lpa8fKfyMKnH1elD9bt1/social-images/social-1780646386961-wgdesigns_logo_small.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/gTvumTS5lpa8fKfyMKnH1elD9bt1/social-images/social-1780646386961-wgdesigns_logo_small.webp" },
    ],
    links: [
